...
exports.default = () => {
    ...
    let result = `Season reset in ${(0, ConvertMsToTime_1.default)(wavesResult)}\n`;
    result += `Hell Mode reset in ${(0, ConvertMsToTime_1.default)(hellResult - 1000 * 60 * 55)}\n`;
    result += `Colonies reset in ${(0, ConvertMsToTime_1.default)(coloniesResult - 1000 * 60 * 5)}\n`;
